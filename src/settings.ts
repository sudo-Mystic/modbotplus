...
export enum Setting {
    ...
    BannedWordsRemovalReason = "bannedWordRemovalReason"
}
...
export const settingsForBanEvasionHandling: SettingsFormField[] = [
   ...
   {
    type: "string",
    name: Setting.BannedWordsRemovalReason,
    label: "Enter Removal Reason for the removed comments, leave empty for no message.",
    defaultValue: "",
},
   /* {
       type: "boolean",
